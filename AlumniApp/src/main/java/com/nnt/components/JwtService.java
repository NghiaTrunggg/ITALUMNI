...
public class JwtService {
    ...
    public String generateTokenLogin(String tendn) {
        String token = null;
        try {
            JWSSigner signer = new MACSigner(SHARED_SECRET_KEY);
            
            JWTClaimsSet.Builder builder = new JWTClaimsSet.Builder();
            builder.claim("tendn", tendn);
    ...
    public String getTendnFromToken(String token) {
        String tendn = null;
        try {
            JWTClaimsSet claims = getClaimsFromToken(token);
            tendn = claims.getStringClaim("tendn");
    ...
    public Boolean validateTokenLogin(String token) {
        ...
        String tendn = getTendnFromToken(token);
        
        return !(tendn == null || tendn.isEmpty() || isTokenExpired(token));
    }
}
